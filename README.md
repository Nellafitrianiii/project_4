# # Langkah Kerja Peta 4: Nearest Neighbor Analysis (QGIS3)
...
Catatan : Kita juga dapat menambahkan lapisan titik sebagai keluaran, gunakan alat Jarak ke hub (titik) terdekat untuk itu.
